...
@section('content')
  <div class="row">
      <form class="form-horizontal form-label-left" action="{{ URL::to('daftar-pribadi/store') }}" method="POST">
        <input type="hidden" name="_token" value="{{ csrf_token() }}">
        <span class="section">Form Pendaftaran WP/WR Pribadi: <label>[Baru]</label></span>
        <div class="col-md-6">
