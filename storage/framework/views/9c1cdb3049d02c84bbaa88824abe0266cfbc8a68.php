    ...
    <ul class="nav side-menu">
        ...
        <ul class="nav child_menu">
          <li><a>Pendaftaran<span class="fa fa-chevron-down"></span></a>
            <ul class="nav child_menu">
              ...
              <li><a href="<?php echo e(URL::to('daftar-bu/table')); ?>">Daftar WP/WR Badan Usaha</a>
              </li>

              <li><a href="<?php echo e(URL::to('cetak_kartu')); ?>">Cetak Kartu NPWPD</a>
              </li>
            </ul>
          </li>
          <li><a>Pendataan<span class="fa fa-chevron-down"></span></a>
            <ul class="nav child_menu">
              <li class="sub_menu"><a href="<?php echo e(url('pendataan/rekam_data')); ?>">Rekam Data Objek Pajak dan Retribusi</a>
              </li>
      ...
      <li><a><i class="fa fa-check-square-o"></i> Penetapan <span class="fa fa-chevron-down"></span></a>
        <ul class="nav child_menu">
          ...
          <li><a href="<?php echo e(URL::to('penetapan/table')); ?>">Daftar Penetapan Pajak</a></li>
      ...
      <li><a><i class="fa fa-suitcase"></i> BKP <span class="fa fa-chevron-down"></span></a>
        <ul class="nav child_menu">
          <li><a>Petugas Loket / Kasir Penerima<span class="fa fa-chevron-down"></span></a>
            <ul class="nav child_menu">
              <li class="sub_menu"><a href="<?php echo e(url('penyetoran')); ?>">Rekam Penerimaan Pajak/Retribusi</a>
              </li>
              <hr>
              <li><a href="<?php echo e(URL::to('bkp/daftar-official')); ?>">Daftar Setoran Official Assesment</a>
              </li>
              <li><a href="<?php echo e(URL::to('bkp/daftar-self')); ?>">Daftar Setoran Self Assesment</a>
              </li>
              <hr>
