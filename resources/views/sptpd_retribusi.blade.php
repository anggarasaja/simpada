...
<div class="">
    <div class="page-title">
      <div class="title_left">
        <h3>Isian SPTPD Retribusi Kekayaan Daerah: 
          @if(isset($id_spt))
      ...
      <div class="title_right">
        <div class="col-md-5 col-sm-5 col-xs-12 form-group pull-right top_search">
              <a href="{{ URL::to('pendataan/sptpd/10') }}" class="btn btn-info"><i class="fa fa-plus"></i> Tambah Baru</a>
              <a href="{{ URL::to('pendataan/lihat_data_retribusi') }}" class="btn btn-primary"><i class="fa fa-list"></i> Lihat Data</a>
        </div>
      </div>
    </div>
    ...
    @if(!isset($id_spt))
    <form action="{{url('pendataan/store_data_retribusi')}}" class="form-horizontal form-label-left" method="POST">
    @else
      @if(!$spr)
        <form action="{{url('pendataan/edit_data_retribusi/'.$id_spt)}}" class="form-horizontal form-label-left" method="POST">
      @else
          ...
          <div class="x_panel">
            <div class="x_content">
                ...
                <div class="item form-group">
                  ...
                  <div class="col-md-1 col-sm-1 col-xs-12">
                    <!-- ## KODE REKENING HOTEL MANUAL = 41101 ###### -->
                ...
                <div class="item form-group">
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    <input id="korek_nama" class="form-control col-md-7 col-xs-12" type="text" name="korek_nama" value="{{ (isset($id_spt)) ? $korek[0]->korek_nama : '' }}" readonly>
                  </div>
                </div>
                <div class="item form-group">
                  <label for="nama_rek" class="control-label col-md-3 col-sm-3 col-xs-12">Keterangan</label>
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    <textarea id="keterangan" class="form-control col-md-7 col-xs-12" type="text" name="keterangan">{{ (isset($id_spt)) ? $spt_detail[0]->spt_dt_lokasi : '' }}</textarea>
                  </div>
                </div>
                ...
                <div class="item form-group">
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    <input class="form-control" type="number" id="pajak_terhutang" name="pajak_terhutang" value="{{ (isset($id_spt)) ? $spt->spt_pajak : '' }}">
                  </div>
                </div>
                <div class="item form-group">
                ...
                <div class="item form-group">
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    <select name="ketetapan" class="form-control">
                      @if(isset($id_spt))
                      <option value="9" {{ ($spt->spt_status == 9) ? 'selected' : '' }}>SKRD</option>
                      <option value="5" {{ ($spt->spt_status == 5) ? 'selected' : '' }}>SKRDKB</option>
                      @else
    ...
    var id_spt = '{{$id_spt or ''}}';
      ...
      function gethistory(wp_wr_id){
        ...
        oTable2 = $('#tbl_hist').DataTable({
          ...
          bFilter: false,   
          ajax: {
            url: "{{ URL::to('pendataan/gethistory/retribusi') }}/"+wp_wr_id,
            type: "GET",
