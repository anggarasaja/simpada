...
<div class="row">
        <div class="x_panel">
        <h2>Tabel Isian SPTPD Pajak Hiburan 
          <a href="{{ URL::to('pendataan/sptpd/3') }}" class="btn btn-info pull-right"><i class="fa fa-plus"></i> Tambah Baru</a>
        </h2>
        <hr>
    ...
    var status = '{{$status or ''}}';
      $(document).ready(function() {
        ...
        oTable = $('#tbl_hist').DataTable({
          ...
          bFilter: true,   
          ajax: {
            url: "{{ URL::to('pendataan/get_data_hibur') }}",
            type: "GET",
            data: {  },
          },
          columns: [
