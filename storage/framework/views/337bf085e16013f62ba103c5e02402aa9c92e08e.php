...
?>
  <div class="row">
      <form class="form-horizontal form-label-left" method="POST" action="<?php echo e(url('/daftar-pribadi/store')); ?>">
        ...
        <div class="col-md-6">
          ...
          <input type="hidden" name="wp_wr_gol" value="<?php echo e(isset($wp_wr_gol) ? $wp_wr_gol : '1'); ?>" size="1" maxlength="1" readonly="true">
          ...
          <div class="item form-group" id="luar_kota">
           ...
           <div class="item form-group">
            ...
            <div class="col-md-8 col-sm-6 col-xs-12">
              <input id="wp_wr_kabupaten" type="text" name="wp_wr_kabupaten" class="optional form-control col-md-7 col-xs-12" value="<?php echo e(isset($wp_wr_kabupaten) ? $wp_wr_kabupaten : 'Pekalongan'); ?>">
            </div>
          </div>
           <div class="item form-group">
            ...
            <div class="col-md-8 col-sm-8 col-xs-12">
              <div class="controls form-inline">
                <select class="form-control" id="wp_wr_jns_tb" name="wp_wr_jns_tb" >
                  ...
                  <input type="text" class=" form-control" placeholder="" id="wp_wr_no_tb" name="wp_wr_no_tb" value="<?php echo e(isset($wp_wr_no_tb) ? $wp_wr_no_tb : ''); ?>">
              </div>
            </div>
          </div>
          <div class="item form-group">
        ...
        <div class="col-md-6">
          <div class="item form-group">
            ...
            <div class="col-md-8 col-sm-6 col-xs-12">
              <input id="wp_wr_no_kk" class="form-control col-md-7 col-xs-12"  name="wp_wr_no_kk" placeholder="" required="required" type="text" value="<?php echo e(isset($wp_wr_no_kk) ? $wp_wr_no_kk : ''); ?>">
            </div>
          </div>
           <div class="item form-group">
          ...
          <div class="item form-group" id="pekerjaan">
            ...
            <div class="col-md-8 col-sm-6 col-xs-12">
              <input id="wp_wr_pekerjaan" class="form-control col-md-7 col-xs-12"  name="wp_wr_pekerjaan" required="required" type="text" placeholder="Masukkan Pekerjaan" value="<?php echo e(isset($wp_wr_pekerjaan) ? $wp_wr_pekerjaan : ''); ?>" readonly>
            </div>
          </div>
          <div class="item form-group">
            ...
            <div class="col-md-8 col-sm-6 col-xs-12">
              <input type="text" id="wp_wr_nm_instansi" name="wp_wr_nm_instansi" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo e(isset($wp_wr_nm_instansi) ? $wp_wr_nm_instansi : ''); ?>">
            </div>
          </div>
          <div class="item form-group">
            ...
            <div class="col-md-8 col-sm-6 col-xs-12">
              <textarea id="wp_wr_alm_instansi" required="required" name="wp_wr_alm_instansi" class="form-control col-md-7 col-xs-12"><?php echo e(isset($wp_wr_alm_instansi) ? $wp_wr_alm_instansi : ''); ?></textarea>  
            </div>
          </div>
