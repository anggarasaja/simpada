...
<div class="">
    <div class="page-title">
      <div class="title_left">
        <h3>Cetak Daftar Kartu Data Pajak Reklame </h3>
      </div>
    ...
    <form id="form_simpan" action="{{url('report/cetak_daftar_reklame')}}" class="form-horizontal form-label-left" method="POST">
    <div class="row">
