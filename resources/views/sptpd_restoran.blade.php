...
<div class="">
  ...
  <div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
      <div class="x_panel">
          <div class="x_title">
            <h2>Isian SPTPD Pajak Restoran:<small>[Baru]</small></h2>
          ...
          <div class="x_content">
            ...
            <input type="hidden" name="_token" value="{{ csrf_token() }}">
              ...
              <div class="col-md-6">
                ...
                <div class="item form-group">
                  <label for="nama_rek" class="control-label col-md-3 col-sm-3 col-xs-12">Pajak</label>
                  <div class="col-md-6 col-sm-6 col-xs-12">
...
<div class="clearfix"></div>
    ...
    <div class="row">
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          <div class="x_title">
            <h2>History Pembayaran Pajak Restoran</h2>
            <ul class="nav navbar-right panel_toolbox">
              <li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a>
              </li>
            </ul>
