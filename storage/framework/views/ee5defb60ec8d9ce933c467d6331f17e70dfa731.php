  ...
  <div class="">
            ...
            <div class="row">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <span class="section">Form Pendaftaran WP/WR Badan Usaha: <label><?php echo e(isset($jenis) ? $jenis : ''); ?></label>  
                  ...
                  <form class="form-horizontal form-label-left" method="POST" action="<?php echo e(URL::to('daftar-bu/store')); ?>">
                  <div class="x_content">
                    ...
                    <div class="" role="tabpanel" data-example-id="togglable-tabs">
                      ...
                      <div id="myTabContent" class="tab-content">
                        ...
                        <div role="tabpanel" class="tab-pane fade active in" id="tab_content1" aria-labelledby="home-tab">
                           ...
                           <div class="x_panel">
                            <div class="col-md-6">
                              <input type="hidden" name="jenis" value="<?php echo e(isset($jenis) ? $jenis : ''); ?>" readonly="true">
                              <input type="hidden" name="wp_wr_id" value="<?php echo e(isset($wp_wr_id) ? $wp_wr_id : ''); ?>" readonly="true">
                              <input type="hidden" name="wp_wr_gol" value="<?php echo e(isset($wp_wr_gol) ? $wp_wr_gol : '2'); ?>" size="1" maxlength="1" readonly="true">
                              ...
                              <input type="hidden" name="wp_wr_pejabat" value="<?php echo e(Auth::user()->opr_id); ?>" readonly>
                              <div class="item form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">No. Reg. Pendaftaran
                                </label>
                                <div class="col-md-8 col-sm-6 col-xs-12">
                                  <div class="input-group">
                                    <input id="no_urut" class="form-control col-md-7 col-xs-12" name="wp_wr_no_urut" required="required" type="text" value="<?php echo e(isset($wp_wr_no_urut) ? $wp_wr_no_urut : $no_urut); ?>" readonly="true">
                              ...
                              <div class="item form-group">
                                ...
                                <div class="col-md-8 col-sm-6 col-xs-12">
                                  <input type="text" id="wp_wr_nama" name="wp_wr_nama"  required="required" class="form-control col-md-7 col-xs-12" value="<?php echo e(isset($wp_wr_nama) ? $wp_wr_nama : ''); ?>">
                                </div>
                              </div>
                              <div class="item form-group">
                                ...
                                <div class="col-md-8 col-sm-6 col-xs-12">
                                  <textarea id="wp_wr_almt" required="required" name="wp_wr_almt" class="form-control col-md-7 col-xs-12" ><?php echo e(isset($wp_wr_almt) ? $wp_wr_almt : ''); ?></textarea>
                                </div>
                              </div>
                              <div class="item form-group">
                                ...
                                <div class="col-md-8 col-sm-6 col-xs-12">
                                  <input type="text" id="wp_wr_kodepos" name="wp_wr_kodepos" required="required" data-inputmask="'mask' : '99999'" class="form-control col-md-7 col-xs-12" value="<?php echo e(isset($wp_wr_kodepos) ? $wp_wr_kodepos : ''); ?>">
                                </div>
                              </div>
                              ...
                              <div class="col-md-6">
                                <div class="item form-group">
                                  ...
                                  <div class="col-md-8 col-sm-6 col-xs-12">
                                    <input type="tel" id="wp_wr_telp" name="wp_wr_telp" required="required"  class="form-control col-md-7 col-xs-12" value="<?php echo e(isset($wp_wr_telp) ? $wp_wr_telp : ''); ?>">
                                  </div>
                                </div>
                                <div class="item form-group">
                              ...
                              <div class="item form-group">
                                ...
                                <div class="col-md-8 col-sm-6 col-xs-12">
                                  <input id="wp_wr_kabupaten" type="text" name="wp_wr_kabupaten" class="optional form-control col-md-7 col-xs-12" value="<?php echo e(isset($wp_wr_kabupaten) ? $wp_wr_kabupaten : ''); ?>">
                                </div>
                              </div>
                          ...
                          <div class="x_panel">
                            <div class="col-md-6">
                              <div class="item form-group">
                                ...
                                <div class="col-md-8 col-sm-6 col-xs-12">
                                  <input type="text" id="wp_wr_nama_milik" name="wp_wr_nama_milik"  required="required" class="form-control col-md-7 col-xs-12" value="<?php echo e(isset($wp_wr_nama_milik) ? $wp_wr_nama_milik : ''); ?>">
                                </div>
                              </div>
                              <div class="item form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="textarea">No. Telepon 
                                ...
                                <div class="col-md-8 col-sm-6 col-xs-12">
                                  <input type="tel" id="wp_wr_telp_milik" name="wp_wr_telp_milik" required="required"  class="form-control col-md-7 col-xs-12" value="<?php echo e(isset($wp_wr_telp_milik) ? $wp_wr_telp_milik : ''); ?>">
                                </div>
                              </div>
                              <div class="item form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="number">Alamat 
                                ...
                                <div class="col-md-8 col-sm-6 col-xs-12">
                                  <textarea id="wp_wr_almt_milik" required="required" name="wp_wr_almt_milik" class="form-control col-md-7 col-xs-12" ><?php echo e(isset($wp_wr_almt_milik) ? $wp_wr_almt_milik : ''); ?></textarea>
                                </div>
                              </div>
                              ...
                              <div class="item form-group">
                                ...
                                <div class="col-md-8 col-sm-6 col-xs-12">
                                  <input type="text" id="wp_wr_kodepos_milik" name="wp_wr_kodepos_milik" required="required" data-inputmask="'mask' : '99999'" class="form-control col-md-7 col-xs-12" value="<?php echo e(isset($wp_wr_kodepos_milik) ? $wp_wr_kodepos_milik : ''); ?>">
                                </div>
                              </div>
                              </div>
                              <div class="col-md-6">
                                ...
                                <div class="col-md-8 col-sm-6 col-xs-12">
                                  <input type="text" id="wp_wr_camat_milik" name="wp_wr_camat_milik"  required="required" class="form-control col-md-7 col-xs-12" value="<?php echo e(isset($wp_wr_camat_milik) ? $wp_wr_camat_milik : ''); ?>">
                                </div>
                              ...
                              <div class="item form-group">
                                ...
                                <div class="col-md-8 col-sm-6 col-xs-12">
                                  <input type="text" id="wp_wr_lurah_milik" name="wp_wr_lurah_milik"  required="required" class="form-control col-md-7 col-xs-12" value="<?php echo e(isset($wp_wr_lurah_milik) ? $wp_wr_lurah_milik : ''); ?>">
                                </div>
                              </div>
                              <div class="item form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="occupation">Kabupaten/Kota 
                                ...
                                <div class="col-md-8 col-sm-6 col-xs-12">
                                  <input id="wp_wr_kabupaten_milik" type="text" name="wp_wr_kabupaten_milik" class="optional form-control col-md-7 col-xs-12" value="<?php echo e(isset($wp_wr_kabupaten_milik) ? $wp_wr_kabupaten_milik : ''); ?>">
                                </div>
                              </div>
...
<?php $__env->stopSection(); ?>
 ...
 <?php $__env->startPush('scripts'); ?>
  ...
  <?php echo Html::script('vendors/jquery.inputmask/dist/min/jquery.inputmask.bundle.min.js');; ?>


    <script> 
    var row_table=<?php echo $row_table ?>;
    var idCamat = '<?php echo e(isset($wp_wr_kd_camat) ? $wp_wr_kd_camat : ''); ?>';
    var idLurah = '<?php echo e(isset($wp_wr_kd_lurah) ? $wp_wr_kd_lurah : ''); ?>';
    var wp_wr_tgl_form_kembali = '<?php echo e(isset($wp_wr_tgl_form_kembali) ? $wp_wr_tgl_form_kembali : ''); ?>';
    var wp_wr_tgl_terima_form = '<?php echo e(isset($wp_wr_tgl_terima_form) ? $wp_wr_tgl_terima_form : ''); ?>';
    var wp_wr_tgl_bts_kirim = '<?php echo e(isset($wp_wr_tgl_bts_kirim) ? $wp_wr_tgl_bts_kirim : ''); ?>';
    var wp_wr_tgl_kartu = '<?php echo e(isset($wp_wr_tgl_kartu) ? $wp_wr_tgl_kartu : ''); ?>';
    var wp_wr_tgl_tb = '<?php echo e(isset($wp_wr_tgl_tb) ? $wp_wr_tgl_tb : ''); ?>';
    var wp_wr_tgl_kk = '<?php echo e(isset($wp_wr_tgl_kk) ? $wp_wr_tgl_kk : ''); ?>';
    var status = '<?php echo e(isset($status) ? $status : ''); ?>';
      ...
      function lurahChange(val){
        text = $("#wp_wr_kd_lurah option:selected").text().split("|");
          ...
          if (val == 84){
            $("#wp_wr_lurah").val('<?php echo e(isset($wp_wr_lurah) ? $wp_wr_lurah : ''); ?>');
