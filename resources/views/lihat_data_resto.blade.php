...
<div class="row">
        <div class="x_panel">
        <h2>Tabel Isian SPTPD Pajak Restoran <a href="{{ URL::to('pendataan/sptpd/2') }}" class="btn btn-info pull-right"><i class="fa fa-plus"></i> Tambah Baru</a>
        </h2>
        <hr>
    ...
    var status = '{{$status or ''}}';
      $(document).ready(function() {
        ...
        oTable = $('#tbl_hist').DataTable({
          ...
          bFilter: true,   
          ajax: {
            url: "{{ URL::to('pendataan/get_data_resto') }}",
            type: "GET",
            data: {  },
          },
          columns: [
              ...
              { data: 'setorpajret_tgl_bayar', name: 'setorpajret_tgl_bayar' }, //tgl setor salah
              { data: 'aksi', name: 'aksi' }, //tgl setor salah
          ],
          order: [[ 0, "desc" ]]
        });
