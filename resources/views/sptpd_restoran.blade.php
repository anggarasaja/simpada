...
<div class="">
    <div class="page-title">
      ...
      <div class="title_right">
        <div class="col-md-5 col-sm-5 col-xs-12 form-group pull-right top_search">
              <a href="{{ URL::to('pendataan/sptpd/2') }}" class="btn btn-info"><i class="fa fa-plus"></i> Tambah Baru</a>
              <a href="{{ URL::to('pendataan/lihat_data_resto') }}" class="btn btn-primary"><i class="fa fa-list"></i> Lihat Data</a>
        </div>
      </div>
    </div>
    ...
    @if(!isset($id_spt))
    <form action="{{url('pendataan/store_data_resto')}}" class="form-horizontal form-label-left" method="POST">
    @else
      @if(!$spr)
        <form action="{{url('pendataan/edit_data_resto/'.$id_spt)}}" class="form-horizontal form-label-left" method="POST">
      @else
          ...
          <div class="x_panel">
            <div class="x_content">
                ...
                <div class="item form-group">
                  ...
                  <div class="col-md-1 col-sm-1 col-xs-12">
                      <input type="text" class=" form-control" placeholder="" id="kd_rek"  name="kd_rek" value="41102" readonly>
                  </div>
                  <div class="col-md-1 col-sm-1 col-xs-12">
                    <label class="control-label pull-right">Jenis</label>
                  </div>
                  <div class="col-md-1 col-sm-1 col-xs-12">
                  ...
                  <div class="col-md-1 col-sm-1 col-xs-12">
                    <label class="control-label pull-right">Klas</label>
                  </div>
                  <div class="col-md-2 col-sm-2 col-xs-12">
                      <div class="input-group">
                ...
                <div class="item form-group">
                  ...
                  <div class="col-md-2 col-sm-2 col-xs-12">
                    <label class="control-label pull-right">Persen Tarif</label>
                  </div>
                  <div class="col-md-2 col-sm-2 col-xs-12">
                      <div class="input-group">
                        <input type="text" placeholder="Persen Tarif %" class="form-control" id="korek_persen_tarif" name="korek_persen_tarif" value="{{ (isset($id_spt)) ? $korek[0]->korek_persen_tarif : '' }}">
                        <span class="input-group-btn">
    ...
    var id_spt = '{{$id_spt or ''}}';
      ...
      function gethistory(wp_wr_id){
        ...
        oTable2 = $('#tbl_hist').DataTable({
          ...
          bFilter: false,   
          ajax: {
            url: "{{ URL::to('pendataan/gethistory/resto') }}/"+wp_wr_id,
            type: "GET",
