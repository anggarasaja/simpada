...
<div class="">
    ...
    <form action="{{url('daftar/proses_buka_wpwr')}}" class="form-horizontal form-label-left" method="POST">
    <div class="row">
            ...
            <div class="x_content">
              ...
              @endif
                ...
                <div class="item form-group">
                  <label class="control-label col-md-3 col-sm-3 col-xs-12" for="tgl_entry">Tanggal Pembukaan 
                  </label>
 ...
 {!! Html::script('vendor/datatables/DataTables-1.10.12/js/jquery.dataTables.min.js'); !!}
    ...
    var status = '{{$status or ''}}';
      ...
      function getnpwpd(){
        ...
        $.ajax({
          type: "GET",
          url: "{{url('pendataan/getnpwpd_tutup')}}/"+npwpd,
          data: {}
        }).success(function(e){
      ...
      function gettablenpwpd(){
        oTable.destroy();
         oTable = $('#table-npwpd').DataTable({
          ...
          serverSide: true,    
          ajax: {
            url: "{{ URL::to('pendataan/getnpwpd_tutup') }}",
            type: "GET",
            data: {  },
          },
          columns: [
