...
<div class="">
    <div class="page-title">
      <div class="title_left">
        <h3>CETAK MEDIA PENETAPAN SKRDKB</h3>
      </div>
    ...
    <form action="{{url('skrdkb/cetak')}}" class="form-horizontal form-label-left" method="POST">
              ...
              @endif
                ...
                <div class="form-group">
                  <div class="col-md-9 col-sm-9 col-xs-12 col-md-offset-3">
                      <button type="submit" class="btn btn-info btn-lg"><i class="fa fa-print"></i> CETAK SKRDKB</button>
                  </div>
                </div>
            </div>
          </div>
