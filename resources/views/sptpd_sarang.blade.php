...
<div class="">
    <div class="page-title">
      <div class="title_left">
        <h3>Isian SPTPD Pajak Walet: <span class="label label-success">[ Baru ]</span></h3>
      </div>
      ...
      <div class="col-md-12 col-xs-12">
          <div class="x_panel">
            <div class="x_content">
                ...
                <div class="item form-group">
                  <table id="tbl_detail" class="table table-striped table-bordered bulk_action">
                    <tr>
                      ...
                      <th>Lokasi</th>
                      <th>Jumlah (Kg) (a)</th>
                      <th>Tarif Dasar (Rp) (b)</th>
                      <th>Dasar Pengenaan (c = axb)</th>
                      <th>(%) (d)</th>
                      <th>Pajak Nilai (Rp) (cxd)</th>
                      <th></th>
                    </tr>
                  </table>
                ...
                <div class="item form-group">
                  <label for="nama_rek" class="control-label col-md-3 col-sm-3 col-xs-12">Total</label>
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    <input class="form-control uang" type="text" readonly id="total" name="total">
                  </div>
                </div>
