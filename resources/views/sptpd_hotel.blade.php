...
<div class="">
    <div class="page-title">
      ...
      <div class="title_right">
        <div class="col-md-5 col-sm-5 col-xs-12 form-group pull-right top_search">
              <a href="{{ URL::to('pendataan/sptpd/1') }}" class="btn btn-info"><i class="fa fa-plus"></i> Tambah Baru</a>
              <a href="{{ URL::to('pendataan/lihat_data_hotel') }}" class="btn btn-primary"><i class="fa fa-list"></i> Lihat Data</a>
        </div>
      </div>
    </div>
    ...
    @if(!isset($id_spt))
    <form action="{{url('pendataan/store_data_hotel')}}" class="form-horizontal form-label-left" method="POST">
    @else
      @if(!$spr)
        <form action="{{url('pendataan/edit_data_hotel/'.$id_spt)}}" class="form-horizontal form-label-left" method="POST">
      @else
                ...
                <div class="item form-group">
                  ...
                  <div class="col-md-2 col-sm-2 col-xs-12">
                    <!-- ## KODE REKENING HOTEL MANUAL = 41101 ###### -->
                      <input type="text" class=" form-control" placeholder="" id="kd_rek"  name="kd_rek" value="41101" readonly>
                  </div>
    ...
    var id_spt = '{{$id_spt or ''}}';
      ...
      function gethistory(wp_wr_id){
        ...
        oTable2 = $('#tbl_hist').DataTable({
          ...
          bFilter: false,   
          ajax: {
            url: "{{ URL::to('pendataan/gethistory/hotel') }}/"+wp_wr_id,
            type: "GET",
